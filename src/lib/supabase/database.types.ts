...
export type ExerciseRow = { id: string; user_id: string | null; name: string; slug: string; muscle_group: string; secondary_muscles: string[]; equipment: string; tracking_type: ExerciseTrackingType; instructions: string[]; aliases: string[]; notes: string | null; is_archived: boolean; is_system: boolean; source: 'system' | 'custom'; created_at: string; updated_at: string }
