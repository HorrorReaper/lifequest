// Shared visual chrome for the unauthenticated auth screens (login, password
// reset). The animated classes it relies on live in globals.css.
      ...
      <div className="relative z-10 flex min-h-svh w-full items-center justify-center px-6 py-10">
        <section className="flex w-full max-w-sm flex-col gap-6">
          <div className="space-y-2 text-center">
            ...
            <h1 className="text-3xl font-black leading-tight">{heading}</h1>
          </div>
          {children}
        </section>
      </div>
