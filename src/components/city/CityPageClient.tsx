...
// docs/superpowers/specs/2026-08-30-avatar-nature-redesign-design.md) — its
// route just redirects. This component is kept fully intact and unused
// rather than deleted, so bringing City back later is a render call away,
// not a rebuild.
