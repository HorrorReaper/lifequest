      ...
      >
        ...
        {isAdmin && (
          <Link
            ...
            className={cn(
              'flex items-center gap-3 rounded-xl border border-primary/30 bg-primary/5 p-3 text-left transition-colors',
              'hover:border-primary/50 hover:bg-primary/10 focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/50'
            )}
          >
            ...
            <span className="min-w-0 flex-1">
              <span className="block text-sm font-semibold">LifeQuest Labs</span>
